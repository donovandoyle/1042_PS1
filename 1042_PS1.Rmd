...
```
**A)** Covariance of X and Y over the variance of X is the formula for OVB. **B)** Distance is confirmed OVB, as it is independent from X (grass) and impacts Y (success).
...
predict(q8, q8data)
```
**A)** I got 88.87% chance again. **B)** I think this may be because R auto-runs a probablistic when the dependent variable is between 0 to 1.
# Question 9
